        ...
        `}>
          ...
          <div className="flex-grow relative py-2">
            <textarea
              ...
              disabled={isLoading}
              className={`
                w-full bg-transparent focus:outline-none resize-none font-sans text-[15px] leading-6 transition-colors duration-300
                text-gray-100 placeholder-gray-500 caret-cyber-accent
                custom-scrollbar min-h-[24px] max-h-[150px]
              `}
              rows={1}
            />
          </div>
